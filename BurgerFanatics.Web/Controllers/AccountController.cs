...
using BurgerFanatics.Sessions;
using BurgerFanatics.Web.Controllers.Results;
using BurgerFanatics.Web.Models;
using BurgerFanatics.Web.Models.Account;
...
{
    public class AccountController : BurgerFanaticsControllerBase
    {
